...
public class Exemplo4 {
      public static void main(String[] args) {//Criacao do metodo main
        ...
        try{ //Simboliza um bloco que pode vir a lançar exceçoes
          ...
          System.out.println(vetor[1]); //printando o valor da posicao 1 do vetor, dando erro por não haver valor nessa posição
...
//          System.out.println(vetor[5]); //printando o valor da posicao 5 do vetor, dando erro por não haver valor nessa posição
        ...
        } finally{//Esse bloco independente de ter uma exceção ou não, ele será executado de qualquer forma
            
            System.out.println("bloco finally executado."); //print demonstrativo que o bloco sera executado, independente de exceções
        }
